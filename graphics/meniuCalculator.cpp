...
void initializare_butoane() {
    ...
    calculeaza.text.setPosition(
            calculeaza.forma.getPosition() + Vector2f(2 * marimeButon.x + spatiu, 0.6f * marimeButon.y) * 0.5f);
    ...
    clear.text.setPosition(
            clear.forma.getPosition() + Vector2f(2 * marimeButon.x + spatiu, 0.7f * marimeButon.y) * 0.6f);
